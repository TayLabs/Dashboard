...
> {
  try {
    ...
    const responseAuth = await fetch(
      `${process.env.AUTH_API_URI}/api/v1/admin/services`,
      {
        method: "GET",
        headers: {
    ...
    const responseKeys = await fetch(
      `${process.env.KEYS_API_URI}/api/v1/services`,
      {
        method: "GET",
        headers: {
          Authorization: `Bearer ${accessToken}`,
...
> {
  try {
    const { accessToken } = await getAccessToken();
    const responseAuth = await fetch(
      `${process.env.AUTH_API_URI}/api/v1/admin/services/${name}`,
      {
        method: "GET",
        headers: {
          Authorization: `Bearer ${accessToken}`,
    ...
    const responseKeys = await fetch(
      `${process.env.KEYS_API_URI}/api/v1/services/${name}`,
      {
        method: "GET",
        headers: {
          Authorization: `Bearer ${accessToken}`,
...
export async function registerService(data: {
  ...
  try {
    ...
    const { accessToken } = await getAccessToken();
    const responseAuth = await fetch(
      `${process.env.AUTH_API_URI}/api/v1/admin/services/register`,
      {
        method: "POST",
        headers: {
          Authorization: `Bearer ${accessToken}`,
    ...
    const responseKeys = await fetch(
      `${process.env.KEYS_API_URI}/api/v1/services/register`,
      {
        method: "POST",
        headers: {
          Authorization: `Bearer ${accessToken}`,
